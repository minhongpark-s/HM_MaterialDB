...
let basket = {
    ...
    addcheckedItem: function(){
        const row_d = document.querySelector('.basketdiv');
        last_div=Object.assign(document.createElement('div'), {
          className: 'row.data',
          innerHTML: `<div class="row data">
                    <div class="subdiv">
        ...
        row_d.appendChild(last_div.firstChild);
    },
    //체크한 장바구니 상품 비우기
